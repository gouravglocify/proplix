	    ...
	    <!-- form data -->
			    <form  class="form-div" >
			            ...
			            <div class="card">
			                <table class="table questionTab">
			                  ...
			                  <tbody>
			                    <tr>
			                      <td>Selling Price</td>
			                      <td><input id="sellingPrice"  value="{{$getReportDetails->sellingprice}}"></td>
			                    </tr>
			                    <tr>
			                      <td>Product Cost</td>
			                      <td><input id="productCost" value="{{$getReportDetails->productcost}}"></td>
			                    </tr>
			                    <tr>
			                      <td>Orders</td>
			                      <td><input id="orders"  value="{{$getReportDetails->orders}}"></td>
			                    </tr>
			                    <tr>
			                      <td>Cancel %</td>
			                      <td><input id="cancel" value="{{$getReportDetails->cancel}}"></td>
			                    </tr>
			                    <tr>
			                      <td>ROAS</td>
			                      <td><input id="roas" value="{{$getReportDetails->roas}}"></td>
			                    </tr>
			                    <tr>
			                      <td>Delivery %</td>
			                      <td><input id="delivery" value="{{$getReportDetails->delivery}}"></td>
			                    </tr>
			                  </tbody>
			                </table>
			            </div>
			      ...
			      <div class="row">
			          ...
			          <table class="table table-bordered">
			                <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td><input value="{{$getReportDetails->shippingcost}}" id="avgShippingCost" ></td>
			                    </tr>
			                    <tr>
			                      <th scope="row">Avg. RTO charge</th>
			                      <td><input  value="{{$getReportDetails->rtocharge}}" id="avgRtoCharge" ></td>
			                    </tr>
			                    <tr>
			        ...
			        <div class="col-md-12 col-lg-4">
			        	<div class="allStatus">
				            <div style="display: @if($getReportDetails->profitperdelivered<10) block @else none @endif;" class="col one __top_box suicide activeDiv" ref="one" id="div_1"><span>SUICIDE! <span>less than 10</span> </span>
				            </div>
				            <div style="display: @if($getReportDetails->profitperdelivered>=10 && $getReportDetails->profitperdelivered<=40) block @else none @endif;" class="col two __top_box noBg activeDiv" ref="two" id="div_2">
				            	<span>NO! <span>b/w 10 &amp; 40</span></span></div>
				            <div style="display: @if($getReportDetails->profitperdelivered>=40 && $getReportDetails->profitperdelivered<=100) block @else none @endif;" class="col three __top_box profiQty activeDiv" ref="three" id="div_3">
				            	<span>Profit if Quantity <span>b/w 40 &amp; 100</span> </span>
				            </div>
				            <div style="display: @if($getReportDetails->profitperdelivered>=100 && $getReportDetails->profitperdelivered<=200) block @else none @endif;" class="col four __top_box profiTab activeDiv" ref="four" id="div_4">
				            	<span>Profitable ✔ <span>b/w 100 &amp; 200</span> </span>
				            </div>
				            <div style="display: @if($getReportDetails->profitperdelivered>=200 && $getReportDetails->profitperdelivered<=300) block @else none @endif;" class="col five __top_box goodTab activeDiv" ref="five" id="div_5">
				            	<span>Very Good✌ <span>b/w 200 &amp; 300</span> </span>
				            </div>
				            <div style="display: @if($getReportDetails->profitperdelivered>=300 && $getReportDetails->profitperdelivered<=400) block @else none @endif;" class="col six __top_box excellentTab activeDiv" ref="six" id="div_6">
				            	<span>Excellent ★ <span>b/w 300 &amp; 500</span> </span>
				            </div>
				            <div style="display: @if($getReportDetails->profitperdelivered>=400) block @else none @endif;" class="col seven __top_box WorldTab activeDiv" ref="seven" id="div_7">
			      ...
			      <div class="row">
			        <div class="col">
			          <input class="form-control form-control-lg" id="reportTitle" placeholder="Enter Report Title..." required value="{{$getReportDetails->title}}">
			        </div>
			        <div class="col">
			      ...
			      <input type="hidden" id="reportId" value="{{base64_encode($getReportDetails->id)}}">
			    </form>
	  		</div>
  	</div>
</div>
...
<script src="{{asset('/js/proplix/editReport.js')}}"></script>
@endsection